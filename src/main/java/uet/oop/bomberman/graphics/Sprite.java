...
public class Sprite {
	...
	public static final int DEFAULT_SIZE = 16; // 1 ô sẽ có kích thước là 16 * 16 pixels
	public static final int SCALED_SIZE = DEFAULT_SIZE * 3; // real size là 16 * 3 = 48 pixel
